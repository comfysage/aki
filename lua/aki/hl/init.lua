...
function M.setup(theme, config)
  ...
  hl_groups = vim.tbl_extend('force', hl_groups, require 'aki.hl.syntax'(theme, config))

  -- merge treesitter hl groups
  hl_groups = vim.tbl_extend('force', hl_groups, require 'aki.hl.treesitter'(theme, config))

  -- merge diagnostic hl groups
  hl_groups = vim.tbl_extend('force', hl_groups, require 'aki.hl.diagnostics'(theme, config))
